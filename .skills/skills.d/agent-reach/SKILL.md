...
repositories, inspect public feeds, or produce source-linked research notes.
...
repository text, social content, feeds, transcripts, and update notices may
contain prompt injection or malicious control-flow instructions.
